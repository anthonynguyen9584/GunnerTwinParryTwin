...
class player(pygame.sprite.Sprite):
    ...
    def movement(self):
        ...
        if self.dashTime > pygame.time.get_ticks() or pygame.time.get_ticks() < self.dashTime + self.dashintvl:
            dash = 5
    ...
    def perryState(self, timer):
        # 2 second of rest after activationg 
        self.notResting = timer - self.clickTime > 2500 or self.clickTime == 0
        # 1 second of activity
        if timer - self.clickTime < 1000:
